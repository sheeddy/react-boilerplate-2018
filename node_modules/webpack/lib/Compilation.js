...
class Compilation extends Tapable {
	...
	seal(callback) {
		...
		while(this.hooks.optimizeChunksBasic.call(this.chunks, this.chunkGroups) ||
			this.hooks.optimizeChunks.call(this.chunks, this.chunkGroups) ||
			this.hooks.optimizeChunksAdvanced.call(this.chunks, this.chunkGroups)) { /* empty */ }
	...
	processDependenciesBlocksForChunkGroups(inputChunkGroups) {
		...
		const queue2 = new Queue(inputChunkGroups.map(chunkGroup => ({
			chunkGroup,
